...
public class BlockListContentData {
    ...
    public BlockListContentData(MigrationsClient.Models.Skybrud.Grid.GridControl control, IPublishedContentType contentType) {
...
public class BlockListContentData<TModel> : BlockListContentData where TModel : PublishedElementModel {
    ...
    public BlockListContentData(MigrationsClient.Models.Skybrud.Grid.GridControl control, IPublishedContentType contentType) : base(control, contentType) { }
